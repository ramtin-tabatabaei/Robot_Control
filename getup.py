...
def sort_assemb_start():
    ...
    joint_angles_end = [0.11, -1.46, -0.11, 1.14, 1.49, 0.04, 0.26]
    move_arm(joint_angles_start, joint_angles_end, t=6)
    rospy.sleep(7)

    joint_angles_start = get_current_joint_positions(joint_names)
    joint_angles_end = [0.12, -1.5, -0.14, 1.87, 1.59, -1.39, 0.17]
    move_arm(joint_angles_start, joint_angles_end, t=6)
    rospy.sleep(7)

    joint_angles_start = get_current_joint_positions(joint_names)
    joint_angles_end = [0.1, 1.01, -0.22, 1.21, 1.43, -1.36, 0.19]
    move_arm(joint_angles_start, joint_angles_end, t=6)
    rospy.sleep(7)
